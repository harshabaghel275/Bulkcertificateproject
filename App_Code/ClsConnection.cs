...
public class ClsConnection
{
     ...
     public ClsConnection()
	{
        ...
        Con.ConnectionString = ConfigurationManager.ConnectionStrings["examsurevy"].ConnectionString;     
   ...
   public DataSet FillDataSet(string query, SqlParameter[] parameters)
   {
